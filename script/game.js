...
function preload() {
    this.load.image('bg', 'assets/transparent.png');
    this.load.image('bug', 'assets/bug-logo.png');
    this.load.image('bigIt', 'assets/B.png');
    this.load.image('x2It', 'assets/X.png');
    this.load.image('moveIt', 'assets/M.png');
    this.load.image('shrinkIt', 'assets/S.png');
}
...
let gameTimeEnd = setTimeout(gameOver, 120000);
